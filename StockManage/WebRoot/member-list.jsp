...
<body class="easyui-layout ">
	<div region="north" border="true" split="true"
		...
		<div class="top-bg">
			...
			用户中心 <span class="c-gray en">&gt;</span> 用户管理 </nav>
			<div class="page-container">

				<div class="cl pd-5 bg-1 bk-gray mt-20">
					<span class="l"> <input onclick="user_edit()" type="submit"
						value="编辑用户" class="btn btn-secondary radius"> <input
						onclick="user_delete()" type="submit" value="删除用户"
						class="btn btn-warning radius"> <input
						onclick="user_show()" type="submit" value="查看用户自选股"
						class="btn btn-secondary radius">
					</span> <span class="r text-c"><input type="text"
						class="input-text" style="width:250px ;font-size:18px"
						placeholder="请输入用户名..." id="" name="">
						<button " class="btn btn-success radius" style="font-size:14px"
							id="" name="">搜用户</button></span>
				</div>
			</div>
		</div>
	</div>
