...
<body class="easyui-layout ">
    <div region="north" border="true" split="true" style="overflow: hidden; height: 135px;">
        ...
        <span class="c-gray en">&gt;</span> 股票中心 <span class="c-gray en">&gt;</span> 股票管理 
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			...
			<a href="javascript:;"	onclick="stock_add('添加用户','member-add.jsp','','510')"class="btn btn-primary radius">
