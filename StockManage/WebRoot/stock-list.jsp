...
<body class="easyui-layout ">
	...
	<script type="text/javascript">
		$(function($) {
			$('#datatable').datagrid({
				...
				columns : [ [//多级表头 列数
				{
					...
					title : '股票数量',
					field : 'stockinfoAmount',
					width : 110
				}, {
					title : '股票抓取时间',
					field : 'stockinfoTicktime',
					width : 120
				}, ] ]
			});
		});
		function user_delete() {
			...
			$.ajax({
				url : "stock/deletebyid.do?id=" + row.stockinfoId,
				dataType : "json",
				type : "post",
				success : alert("删除成功!"),
