...
<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			...
			<i class="Hui-iconfont">&#xe603;</i>编辑文章</a> 
			
			<a href="javascript:;" onclick="user_delete()" class="btn btn-warning radius">
			<i class="Hui-iconfont">&#xe6e2;</i>删除文章</a> 
			
			<a href="javascript:;"	onclick="user_add('添加用户','article-add.jsp','','510')"class="btn btn-primary radius">
			<i class="Hui-iconfont">&#xe600;</i>添加文章</a></span> 
			
			<span class="r text-c"><input type="text" class="input-text" style="width:250px; font-size:20px" placeholder="请输入文章名称...." id="" name="">
		<button type="submit" class="btn btn-success radius" style="font-size:20px" name=""><i class="Hui-iconfont">&#xe665;</i> 搜用户</button></span>
		</div>
</div>
        </div>
    </div>
