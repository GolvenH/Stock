...
<![endif]-->
<title>欢乐股后台管理系统</title>
	<meta http-equiv="keywords" content="欢乐股后台管理系统,欢乐股网站管理,Admain登录">
	<meta http-equiv="description" content="欢乐股网站是一款由国人开发的轻量级扁平化股票自选模拟学习网站，完全免费注册，模拟炒股，在线论坛，网站现已开源">
	</head>
<body>
<header class="Hui-header cl"> <a class="Hui-logo l" title="欢乐股网站后台管理系统" >欢乐股网站后台管理系统.admin</a> 
<a class="Hui-logo-m l" title="欢乐股网站后台管理系统.admin">欢乐股网站后台管理系统</a> <span class="Hui-subtitle l">V0.1</span>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a _href="article-list.jsp" href="javascript:void(0)">资讯管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="product-brand.jsp" href="javascript:void(0)">品牌管理</a></li>
					<li><a _href="product-category.jsp" href="javascript:void(0)">分类管理</a></li>
					<li><a _href="product-list.jsp" href="javascript:void(0)">产品管理</a></li>
				</ul>
			</dd>
		</dl>
		<!--<dl id="menu-page">
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a _href="member-list.jsp" href="javascript:;">会员列表</a></li>
					<li><a _href="member-del.jsp" href="javascript:;">删除的会员</a></li>
					<li><a _href="member-record-browse.jsp" href="javascript:void(0)">浏览记录</a></li>
					<li><a _href="member-record-download.jsp" href="javascript:void(0)">下载记录</a></li>
					<li><a _href="member-record-share.jsp" href="javascript:void(0)">分享记录</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					...
					<li><a _href="admin-list.jsp" href="javascript:void(0)">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					<li><a _href="system-base.jsp" href="javascript:void(0)">系统设置</a></li>
					<li><a _href="system-category.jsp" href="javascript:void(0)">栏目管理</a></li>
					<li><a _href="system-data.jsp" href="javascript:void(0)">数据字典</a></li>
					<li><a _href="system-shielding.jsp" href="javascript:void(0)">屏蔽词</a></li>
					<li><a _href="system-log.jsp" href="javascript:void(0)">系统日志</a></li>
				</ul>
			</dd>
		</dl>
	</div>
